...
class DataLoaderTrain(Dataset):
    def __init__(self, gt_dir, input_dir, img_options=None, target_transform=None):
...
class DataLoaderTrain_Gaussian(Dataset):
    def __init__(self, rgb_dir, noiselevel=25, img_options=None, target_transform=None):
...
class DataLoaderTest(Dataset):
    def __init__(self, gt_dir, input_dir, target_transform=None):
